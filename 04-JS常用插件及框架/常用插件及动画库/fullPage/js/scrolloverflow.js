/**
* Customized version of iScroll.工具 0.1.2
* It fixes bugs affecting its integration with fullpage.工具
* @license
*/
...
if ( typeof module != 'undefined' && module.exports ) {
    ...
    //making sure scrollOverflow works when using Require.工具
    //in the browser
...
/*!
* Scrolloverflow 2.0.2 module for fullPage.工具 >= 3
...
(function (window, document) {
    window.fp_scrolloverflow = (function() {
        ...
        */
         ...
         * to the fullpage.工具 option that implements the same functions
         * as this handler.
         *
         * @type {Object}
         */
        ...
        var iscrollHandler = {
            ...
            // Default options for iScroll.工具 used when using scrollOverflow
            iscrollOptions: {
                scrollbars: true,
                mouseWheel: true,
            ...
            update: function(element, scrollHeight) {
                ...
                iscrollHandler.refreshId = setTimeout(function(){
                    iscrollHandler.iScrollInstances.forEach(function(instance){
                        ...
                        //otherwise done on the fullpage.工具 reBuild function
