...
(function( root, window, document, factory, undefined) {
    ...
    function initialise(containerSelector, options) {
        ...
        */
        ...
        /**
        * Turns fullPage.工具 to normal scrolling mode when the viewport `width` or `height`
        ...
        */
        ...
        /**
        * Determines whether the focus is outside fullpage.工具 sections/slides or not.
        */
        ...
        */
        ...
        /*
        * Destroys fullpage.工具 plugin events and optinally its html markup and styles
        */
        ...
        /*
        * Removes inline styles added by fullpage.工具
        */
        ...
        */
        function displayWarnings(){
            ...
            if(!isOK){
                showError('error', 'Fullpage.工具 version 3 has changed its license to GPLv3 and it requires a `licenseKey` option. Read about it here:');
                showError('error', 'https://github.com/alvarotrigo/fullPage.js#options.');
            }
            else if(l && l.length < 20){
                console.warn('%c This website was made using fullPage.工具 slider. More info on the following website:', msgStyle);
            ...
            if(hasClass($('html'), ENABLED)){
                showError('error', 'Fullpage.工具 can only be initialized once and you are doing it multiple times!');
                return;
            }
            ...
            if(options.scrollOverflow && options.scrollOverflowHandler == null){
                ...
                showError('error', 'The option `scrollOverflow:true` requires the file `scrolloverflow.min.工具`. Please include it before fullPage.工具.');
            }
            ...
            extensions.forEach(function(extension){
                ...
                if(options[extension]){
                    showError('warn', 'fullpage.工具 extensions require fullpage.extensions.min.工具 file instead of the usual fullpage.工具. Requested: '+ extension);
                }
            });
    ...
    * @param {Object} props less properties and values.
    */
...
/**
 * jQuery adapter for fullPage.工具 3.0.0
 */
